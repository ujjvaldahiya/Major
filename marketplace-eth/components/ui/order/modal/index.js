        ...
        <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            ...
            <div className="sm:flex sm:items-start">
                ...
                <div className="mt-1 relative rounded-md">
                    ...
                    Price will be verified at the time of the order. If the price is lower, order can be declined (+- 2% slippage is allowed)
                    </p>
                </div>
                ...
                <div className="text-xs text-gray-700 flex">
                    ...
                    <span>I accept Cryptonite's &apos;terms of service&apos; and agree that the order can be rejected in case data provided above is incorrect</span>
                </div>
                </div>
            </div>
            </div>
